...
export const Route = createFileRoute("/image-collage")({
  head: () =>
    buildSeoMeta({
      title: "Photo Collage Maker (2, 3, 4 Photos) — Toolbox | Free Online Grid",
      description:
        "Create beautiful multi-photo collages with strictly 2, 3, or 4 pictures. Choose custom templates, spacing, rounded corners, aspect ratios, and backgrounds online for free.",
      path: "/image-collage",
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">• Free & High Resolution</span>
            </div>
          </div>
        </div>
        <p className="mt-3 text-muted-foreground">
          Arrange your photos into clean, high-resolution compositions. Pick 2, 3, or 4 photos,
          choose from multi-tile layout blueprints, customize margins and rounded corners, and
          download your finished collage in PNG, JPG, or WEBP.
        </p>
